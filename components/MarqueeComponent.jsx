...
export default function MarqueeComponent() {
  return (
    <div className="marq xl:w-8/12 lg:w-12/12 lg:w-12/12 w-full lg:px-8 px-2 mx-auto xl:py-10 lg:py-10 md:py-10 py-12 border-b-[1px] mb-5 xl:mb-10 lg:mb-10 md:mb-10 border-[#40d3b94d]">
          ...
          <div className="default-content-container flex items-center">
            <div className="default-content-container-inner relative overflow-hidden inline-block">
              <div className="marquee">
                <a href="/pages/press" className="mr-12">
                  <Image
                    height={39}
                    width={130}
