...
export default function GoogleReview(props) {
        ...
        <div className="mx-3">
          <div className="flex flex-col mt-10 item-center">
              ...
              {showFullContent ? (
                ...
                <p className="xs:text-xs   mt-5 xl:text-base">
                  ...
                  <button
                    ...
                    className="xl:font-bold md:font-bold xs:font-bold text-[14px] text-[#000]"
                  >
                    Read More
                  </button>
                </p>
            ...
            <div className="flex flex-row justify-between">
              <div>
                {" "}
                <p className="font-bold text-[16px] text-[#000] mt-5">
                  {" "}
                  Devashi Desai
                </p>
              </div>
            ...
            <div>
              ...
              {showFullContent3 ? (
                <p className="xs:text-xs mt-5 xl:text-base">
                  ...
                  hair coach Uriah has been a support to me, she&apos;s always a
                  text away and has been very patient in listening to all my
        ...
        <div className="mx-3">
          <div className="flex flex-col mt-10 item-center">
            ...
            <div className="flex flex-row justify-between">
              <div>
                {" "}
                <p className="font-bold text-[16px] text-[#000] text-[#000] mt-5">
                  {" "}
  ...
  return (
    <div>
      <div>
        <p
          className={`${nunito.variable} font-bold xl:text-[35px] lg:text-[35px] md:text-[35px] xs:text-2xl text-center text-[#3f3f3f] mt-8 mb-2`}
        >
          Google Reviews
        </p>
      </div>
      ...
      <div className="xl:flex md:hidden xs:hidden justify-center">
        <Slider
          {...settings2}
          className="2xl:w-[1110px] lg:w-9/12 xs:w-10/12 flex items-center justify-center"
        >
          {element.map((value, index) => {
            return (
              <div key={index} className="">
