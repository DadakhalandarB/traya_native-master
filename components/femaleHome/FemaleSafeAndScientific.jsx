...
const FemaleSafeAndScientific = () => {
  return (
    <div>
      {" "}
      <div className="flex flex-col justify-center items-center xl:mb-5 lg:mb-5">
        <h2
          className={`${nunito.variable} xl:text-[35px] xs:text-[30px] lg:text-[35px] md:text-[35px] mt-4 tracking-wide font-bold xl:mt-10 text-[#3f3f3f] xs:px-10`}
        >
          Safe And Scientific
        </h2>
      </div>
...
export default FemaleSafeAndScientific;
